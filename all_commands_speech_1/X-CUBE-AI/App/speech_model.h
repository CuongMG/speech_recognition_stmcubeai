...
#ifndef AI_SPEECH_MODEL_H
#define AI_SPEECH_MODEL_H
#pragma once
...
/******************************************************************************/
#define AI_SPEECH_MODEL_MODEL_NAME          "speech_model"
#define AI_SPEECH_MODEL_ORIGIN_MODEL_NAME   "speechcommandsmodelnot"

/******************************************************************************/
#define AI_SPEECH_MODEL_ACTIVATIONS_ALIGNMENT   (4)
#define AI_SPEECH_MODEL_INPUTS_IN_ACTIVATIONS   (4)
#define AI_SPEECH_MODEL_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_SPEECH_MODEL_IN_NUM        (1)

AI_DEPRECATED
#define AI_SPEECH_MODEL_IN \
  ai_speech_model_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_SPEECH_MODEL_IN_SIZE { \
  AI_SPEECH_MODEL_IN_1_SIZE, \
}
#define AI_SPEECH_MODEL_IN_SIZE_BYTES { \
  AI_SPEECH_MODEL_IN_1_SIZE_BYTES, \
}
#define AI_SPEECH_MODEL_IN_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_SPEECH_MODEL_IN_1_HEIGHT      (16)
#define AI_SPEECH_MODEL_IN_1_WIDTH       (28)
#define AI_SPEECH_MODEL_IN_1_CHANNEL     (1)
#define AI_SPEECH_MODEL_IN_1_SIZE        (16 * 28 * 1)
#define AI_SPEECH_MODEL_IN_1_SIZE_BYTES  (1792)

/******************************************************************************/
#define AI_SPEECH_MODEL_OUT_NUM       (1)

AI_DEPRECATED
#define AI_SPEECH_MODEL_OUT \
  ai_speech_model_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_SPEECH_MODEL_OUT_SIZE { \
  AI_SPEECH_MODEL_OUT_1_SIZE, \
}
#define AI_SPEECH_MODEL_OUT_SIZE_BYTES { \
  AI_SPEECH_MODEL_OUT_1_SIZE_BYTES, \
}
#define AI_SPEECH_MODEL_OUT_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_SPEECH_MODEL_OUT_1_CHANNEL     (38)
#define AI_SPEECH_MODEL_OUT_1_SIZE        (38)
#define AI_SPEECH_MODEL_OUT_1_SIZE_BYTES  (152)

/******************************************************************************/
#define AI_SPEECH_MODEL_N_NODES (11)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup speech_model
 ...
 * @ref ai_speech_model_create. Both the activations memory buffer 
 ...
 * using @ref ai_speech_model_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_speech_model_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_speech_model_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_SPEECH_MODEL_*
 * defines into file @ref speech_model.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_speech_model_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_SPEECH_MODEL_H */
